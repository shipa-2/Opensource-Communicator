...
> **Критический баг (исправлен):** в ранних сборках **0.3.0** окно **входящего звонка** перехватывало фокус клавиатуры. Нажатие **Esc** (часто предназначенное другому приложению) **случайно сбрасывало вызов**. Сейчас входящий звонок показывается **без активации окна**, а **Esc не завершает звонок** — только явная кнопка «Сброс».
...
- **Аккаунт**: аватар (фото/цвет), отображаемое имя, выход из аккаунта
